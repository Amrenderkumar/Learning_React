        ...
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
                    <img className="w-96" src="https://thumbs.dreamstime.com/b/man-coding-vector-concept-young-guy-digital-tablet-freelanxer-distant-employee-specialist-programmer-develop-mobile-304131774.jpg" alt="image1" />
                </div>
            </aside>
            ...
            <div>
                <p>This is the page of Content</p>
            </div>
